    ...
    def __init__(self, new_insn_json, riscv_path_name, backup_path):
        if os.path.exists(riscv_path_name) == False:
            ...
            for i in range(len(insn_dict["instructions"])):
                ...
                if f.is_file():
                    file_name = os.path.join(riscv_path_name, "insns/" + insn_dict["instructions"][i]["insn_name"] + ".h")
                    print("opening " + file_name)
                    i_handle = open(os.path.join(riscv_path_name, "insns/" + insn_dict["instructions"][i]["insn_name"] + ".h"), "r")
            ...
            for i in range(len(insn_dict["instructions"])):
                ...
                g = nx.readwrite.json_graph.adjacency_graph(insn_dict["instructions"][i]["graph"])
